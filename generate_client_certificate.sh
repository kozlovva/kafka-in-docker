...
echo "\nGenerating KeyStore:\n"
keytool -genkey -keystore kafka.client.keystore.jks -validity 365 -storepass $CLIENT_KEY_PASS -keypass $CLIENT_KEY_PASS -dname "CN=$CN" -storetype pkcs12 -keyalg RSA
