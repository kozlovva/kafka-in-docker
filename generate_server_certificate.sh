...
echo "\nGenerating KeyStore:\n"
keytool -genkey -keystore kafka.server.keystore.jks -validity 365 -storepass $SERVER_KEY_PASS -keypass $SERVER_KEY_PASS -dname "CN=$CN" -storetype pkcs12 -keyalg RSA
